  ...
  ColumnLayout {
    ...
    Item {
      ...
      SlimProgressbarRotated {
        ...
        Image {
          id: skillMarker
          anchors{bottom: parent.bottom; bottomMargin: Math.round(skillBar.height*0.25 - height*0.5); left: parent.left;}
          source: "/images/marker-left.png"
        } // Image
        ...
        Image {
          anchors{bottom: parent.bottom; bottomMargin: Math.round(skillBar.height*0.75 - height*0.5); left: parent.left;}
          source: "/images/marker-left.png"
        } // Image
