...
Item {
  ...
  BorderImage {
    ...
    border { left: TibiaStyle.sidebarButtonWidth + TibiaStyle.statusBarBackgroundBorderWidth; right: TibiaStyle.statusBarBackgroundBorderWidth;
             top: Math.min(background.height,TibiaStyle.sidebarButtonHeight); bottom: TibiaStyle.statusBarBackgroundBorderWidth }
    source: "/images/borderimage-statusbar-left.png"
    verticalTileMode: BorderImage.Repeat
    width: outerLayout.anchors.leftMargin + outerLayout.width + TibiaStyle.marginNarrow + TibiaStyle.statusBarBackgroundBorderWidth
    smooth: false
    ...
    RowLayout {
      id: outerLayout
      anchors { left: background.left; top: background.top; bottom: background.bottom;
      ...
      ColumnLayout { // experience, if selected, it has to be shown first (always)
        ...
        TibiaIconButton {
          ...
          sourceUp: "/images/button-storexp-noborder-left-idle.png"
          sourceDown: "/images/button-storexp-noborder-left-pressed.png"
      ...
      GridLayout {
        ...
        rowSpacing: TibiaStyle.marginRelated//TibiaStyle.marginNarrow
        ...
        Repeater {
          ...
          StatusBarSkillLeft {
            ...
            property int initialIndex: (modelData % 2 == 0 ? (modelData + 1) : (modelData -1))
        ...
        Component {
          ...
          ColumnLayout {
            ...
            StatusBarProficiencyButton {
              ...
              positionType: StatusBarProficiencyButton.PositionType.Left
              Layout.topMargin: -3
