...
MAP_ICON_INDEX: Dict[str, Tuple[Optional[int], Optional[int]]] = {
    ...
    "exura san": (1, 125),
    "utito mas sio": (117, 126),
    "utamo mas sio": (119, 127),
    "utura mas sio": (122, 128),
    "utori mas sio": (110, 129),
    "adori san": (75, 130),
    "utani tempo hur": (97, 131),
    "utamo tempo": (118, 132),
    "utito tempo": (95, 133),
    "utamo tempo san": (116, 134),
    "utori flam": (54, 138),
    "utori mort": (53, 139),
    "utori vis": (55, 140),
    "utori kor": (56, 141),
    ...
    "utura gran": (15, 160),
    "exura dis": (124, 166),
    "exevo dis flam hur": (125, 167),
    "adori dis min vis": (126, 168),
    "exori min flam": (123, 169),
    "exori infir tera": (133, 172),
    "exevo infir frigo hur": (132, 173),
    "exura infir": (130, 174),
    "exura infir ico": (131, 175),
    "exevo infir con": (134, 176),
    "exori infir vis": (129, 177),
    "exevo infir flam hur": (128, 178),
    "adori infir vis": (None, 179),
    "adori infir mas tera": (None, 180),
    "utevo gran res eq": (139, 194),
    "utevo gran res sac": (141, 195),
    "utevo gran res ven": (142, 196),
    "utevo gran res dru": (140, 197),
    "exeta amp res": (109, 237),
    "exana amp res": (135, 238),
    "exura med ico": (4, 239),
    "exevo gran flam hur": (102, 240),
    "exura max vita": (107, 241),
    "exura gran sio": (106, 242),
    "exana vita": (143, 245),
    "exiva moe res": (144, 248),
    "exevo tempo mas san": (152, 258),
    "exevo max mort": (154, 260),
    "exori amp kor": (149, 261),
    "exevo ulus tera": (151, 262),
    "exevo ulus frigo": (150, 263),
    "uteta res eq": (145, 264),
    "uteta res sac": (147, 265),
    "uteta res ven": (148, 266),
    "uteta res dru": (146, 267),
    "utevo grav san": (155, 268),
    "exori infir con": (156, 270),
    "exori infir min": (157, 271),
    "exura gran tio": (158, 273),
    "utori virtu": (159, 274),
    "utito virtu": (160, 275),
    "utura tio": (161, 276),
    "utevo mas sio": (163, 278),
    "utevo nia": (164, 279),
    "exori mas res": (165, 280),
    "utamo tio": (166, 281),
    "utevo gran res tio": (167, 282),
    "uteta res tio": (168, 283),
    "exori infir pug": (169, 284),
    "exori pug": (170, 285),
    "exori gran pug": (171, 286),
    "exori mas pug": (172, 287),
    "exori med pug": (173, 288),
    "exori gran mas pug": (174, 289),
    "exori amp pug": (175, 290),
    "exori infir nia": (176, 291),
    "exori nia": (177, 292),
    "exori gran nia": (178, 293),
    "exori mas nia": (179, 294),
    "exori gran mas nia": (180, 295),
    "exura mas nia": (181, 296),
    "exura tio sio": (182, 297),
    "exori infir amp pug": (183, 300),
    "exori mas amp pug": (184, 301),
    "exori dir san": (185, 302),
    "exori dir moe": (186, 303),
    "uteta flam": (187, 304),
    "uteta vis": (188, 305),
    "uteta mort": (189, 306),
    "utura sio": (191, 309),
    "exevo mort ora": (192, 310),
    "exori kor tempo": (199, 311),
    "exori moe tempo": (200, 312),
    "utori con": (193, 313),
    "utori hur": (194, 314),
    "exori ico scu": (195, 315),
    "exori scu": (196, 316),
    "exevo fur frigo": (197, 317),
    "exevo fur tera": (198, 318),
    "utito dru": (190, 319),
}
